        ...
        try{
            ...
            tournaments.forEach(tournament => {
                ...
                <div class="mx-auto w-fit">
                    <a href="2026/tournaments/?id=${tournament.id}"> <button class="border- rounded-[10px] border-gamefest bg-gamefest px-6 py-4 text-xl font-bold text-black duration-150 hover:cursor-pointer hover:brightness-75">More Details</button></a>
                </div>
                `;
